...
class RunPaths:
    ...
    handoff_dir: Path
    tasks_json: Path
    apphud_config_json: Path
    attribution_config_json: Path
    apk: Path
    ...
    def create(cls, base: Path) -> RunPaths:
        ...
        rp = cls(
            ...
            apphud_config_json=run_dir / "apphud_config.json",
            attribution_config_json=run_dir / "attribution_config.json",
